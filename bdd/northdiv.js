...
async function insertData() {
  ...
  try {
    for (let i = 1; i <= 50; i++) {
      const query = `
        INSERT INTO northdiv(e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23)
...
async function getData(ide) {
  ...
  try {
   const query = 'SELECT e1, e2, e3, e4, e5, e6, e7, e8, e9, e10, e11, e12, e13, e14, e15, e16, e17, e18, e19, e20, e21, e22, e23 FROM northdiv WHERE id = $1';
