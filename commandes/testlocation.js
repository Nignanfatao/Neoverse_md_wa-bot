...
zokou(
  ...
  async (dest, zk, commandeOptions) => {
    ...
    // Détection de la position dans le message
    const match = message.match(/🌍position:\s*(\d+)\s*km/i);
    if (!match) return repondre("❌ Format incorrect. Utilisez : 🌍position: [distance]km");
    ...
    // Envoi de la localisation avec l'image
